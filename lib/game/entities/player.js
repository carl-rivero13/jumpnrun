...
EntityPlayer = ig.Entity.extend({
	...
	init: function( x, y, settings ) {
		...
		this.addAnim( 'run', 0.07, [3,5,4,3,5,4,3] );
		this.addAnim( 'jump', 0.07, [7,12,8,12,7] );
		this.addAnim( 'fall', 0.07, [12,7], true ); // stop at the last frame
		this.addAnim( 'pain', 0.07, [14,15], true );
